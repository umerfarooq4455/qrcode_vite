...
export default class QRCornerSquare {
  ...
  draw(x: number, y: number, size: number, rotation: number): void {
    ...
    switch (type) {
      ...
      case cornerSquareTypes.extraRounded:
        drawFunction = this._drawExtraRounded;
        break;
      case cornerSquareTypes.twosidecorner:
        drawFunction = this._drawTwosidecorner;
        break;
  ...
  _basicTwosidecorner(args: BasicFigureDrawArgsCanvas): void {
    const { size, context } = args;
  ...
  _drawTwosidecorner({ x, y, size, context, rotation }: DrawArgsCanvas): void {
    this._basicTwosidecorner({ x, y, size, context, rotation });
  }
}
