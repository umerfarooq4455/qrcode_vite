...
import CouponColor from "./CouponColor";
import CouponFont from "./CouponFont";
import CouponWelcom from "./CouponWelcom";
import CouponLocation from "./CouponLocation";
    ...
    <>
      <div className="dark:text-white ">
        ...
        <div className="mt-[14px]">
          ...
          <p className="text-sm">
            Enter the Coupon code related content to complete the QR Code.
          </p>
        </div>
        {/* heading  */}
