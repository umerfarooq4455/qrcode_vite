...
import Mp3Desing from "./Mp3Desing";
import Fonts from "./Fonts";
import Bacisinformation from "./Bacisinformation";
    ...
    <>
      <div className="dark:text-white">
        ...
        <div className="mt-[14px]">
          ...
          <p className="text-sm">
            Enter the Mp3 related content to complete the QR Code.
          </p>
        </div>
        {/* heading  */}
