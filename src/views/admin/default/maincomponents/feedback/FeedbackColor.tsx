...
const FeedbackColor: React.FC = () => {
  ...
  const [colorLinktextIndex, setColorLinktextIndex] = useState<number | null>(
    null
  );
  // link color related state //
  ...
  const handleBackgroundColorPicker = (color: { hex: string }) => {
    const { hex } = color;
  ...
  const handleLinkBgColorPicker = (color: { hex: string }) => {
    const { hex } = color;
  ...
  const handleLinkTextColorPicker = (color: { hex: string }) => {
    const { hex } = color;
