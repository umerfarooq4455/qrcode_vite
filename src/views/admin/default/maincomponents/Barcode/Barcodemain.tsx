...
import Barcodewelcoms from "./Barcodewelcoms";
import Basicinfo from "./Basicinfo";

interface BarcodemainProps {}

const Barcodemain: React.FC<BarcodemainProps> = () => {
  const { setQRCode, websiteUrl, darkmode } = useApiContext();
    ...
    <>
      <div className="dark:text-white">
        ...
        <div className="mt-[14px]">
          ...
          <p className="text-sm">
            Enter the Barcode related content to complete the QR Code.
          </p>
        </div>
        {/* heading */}
