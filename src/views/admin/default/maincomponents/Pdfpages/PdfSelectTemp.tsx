...
import image2 from "./pdfimges/template-1.9eae08bafe6e003450f1.webp";
import image3 from "./pdfimges/template-2.6779d1eaaec205a5fab9.webp";
import image4 from "./pdfimges/template-3.4304c1d5e948f13e88d8.webp";
import image5 from "./pdfimges/template-4.023e7b80e39bfb1ade1d.webp";
import image1 from "./pdfimges/template-default.9d0ada8bad09c54ea62d.webp";
      ...
      <div className="rounded-[10px] border-[1px] border-gray-300 bg-white px-5 font-dm text-[16px] font-semibold shadow-sm shadow-[#003EFF1A] dark:border-[#191A1F] dark:bg-[#13151E] dark:text-[#fff]">
        ...
        {activeIndex === 1 && (
          <div className="overflow-x-scroll">
            <div className="mb-2 flex gap-3 pb-2 mt-2">
              {Templates.map((temp) => (
                <div
                  key={temp.id}
