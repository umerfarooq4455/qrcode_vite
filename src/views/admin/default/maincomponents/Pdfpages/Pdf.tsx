...
import Defulttemp from "./templates/defulttemp";
import PdfTemplate1 from "./templates/PdfTemplate1";
import PdfTemplate2 from "./templates/PdfTemplate2";
import PdfTemplate3 from "./templates/PdfTemplate3";
import PdfTemplate4 from "./templates/PdfTemplate4";
...
const Pdf: React.FC = () => {
  ...
  const { selectedpdfTemp } = usePdfMode();
  ...
  const overlayStyle: React.CSSProperties = {
    ...
    zIndex: 10,
    flexDirection: "column", // Corrected 'coluom' to 'column'
  };
    ...
    <>
      <div className="dark:text-white ">
        ...
        <div className="mt-[14px]">
          ...
          <p className="text-sm">
            Enter the PDF related content to complete the QR Code.
          </p>
        </div>
        {/* heading  */}
              ...
              <div className="">
                ...
                <div className="view py-4">
                  <div className="relative">
                    ...
                    >
                      {selectedpdfTemp === "1" && <Defulttemp />}
                      {selectedpdfTemp === "2" && <PdfTemplate1 />}
                      {selectedpdfTemp === "3" && <PdfTemplate2 />}
                      {selectedpdfTemp === "4" && <PdfTemplate3 />}
                      {selectedpdfTemp === "5" && <PdfTemplate4 />}
                      {["1", "2", "3", "4", "5"].includes(selectedpdfTemp) || (
                        <Defulttemp />
                      )}
                    </div>
                  </div>
