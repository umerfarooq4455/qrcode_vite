...
const PdfTemplate2: React.FC = () => {
  ...
  return (
    <div
      style={gradientStyle}
      className={`flex flex-col items-center overflow-y-auto rounded-bl-[30px] rounded-br-[30px] rounded-tl-[30px] rounded-tr-[30px] bg-gradient-to-b from-[${primary}] to-[${secondary}] text-center dark:text-[#000]`}
    >
      <div className="">
