...
const Landingmain: React.FC = () => {
  const { setQRCode, websiteUrl } = useApiContext();
    ...
    <>
      <div className="dark:text-white ">
        ...
        <div className="mt-[14px]">
          ...
          <p className="text-sm">
            Enter the Landing page related content to complete the QR Code.
          </p>
        </div>
        {/* heading  */}
        ...
        <div className="flex w-full flex-col justify-between py-2 lg:flex-row ">
          ...
          <div className="flex flex-col items-center ">
            ...
            <div className="hidden lg:block">
              <div className="mt-4 flex w-[86px] items-center justify-center rounded-full border-[1px] border-[#C7C9D3] bg-[#fff] dark:border-[#202125] dark:bg-[#13151E]">
                <button
