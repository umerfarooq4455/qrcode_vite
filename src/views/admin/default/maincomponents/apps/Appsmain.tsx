...
import AppsWelcom from "./AppsWelcom";
import AppsColor from "./AppsColor";
import AppsFont from "./AppsFont";
import AppsInfo from "./AppsInfo";
import Custumizedbutoon from "./Custumizedbutoon";

const Appsmain: React.FC = () => {
    ...
    <>
      <div className="dark:text-white">
        ...
        <div className="mt-[14px]">
          ...
          <p className="text-sm">
            Enter the Apps code related content to complete the QR Code.
          </p>
        </div>
        {/* heading */}
