              ...
              >
                ...
                >
                  <div className="flex items-center justify-center">
                    <div className="flex h-[42px] w-[42px] items-center justify-center rounded-full border-[1px] border-[#B8BAC780]">
                      <img src={previewImage} className="w-[40px]" alt="" />
                    </div>
                  ...
                  <div className="flex items-center justify-center">
                    ...
                    />
                    <img src={togglescard} onClick={toggleHandler} />
                  </div>
                </div>
              </div>
            ))}
