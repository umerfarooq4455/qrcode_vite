...
import BussinessTemp from "./BussinessTemp";
import BusDesig from "./BusDesig";
import BusFont from "./BusFont";
    ...
    <>
      <div className="dark:text-white">
        ...
        <div className="mt-[14px]">
          ...
          <p className="text-sm">
            Enter the Business-related content to complete the QR Code.
          </p>
        </div>
        {/* heading */}
              ...
              <div className="">
                ...
                <div className="view py-4">
                  <div className="relative">
                    ...
                    >
                      {/* Add content for overlay */}
                    </div>
                  </div>
                </div>
              </div>
            </div>
            {/* mobile view and QR code view buttons */}
