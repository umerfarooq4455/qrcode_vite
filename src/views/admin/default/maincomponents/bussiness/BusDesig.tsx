...
const BusDesig = () => {
  ...
  const handleColorClick = (index: number) => {
    const bgcolorValue = backgroudcolor[index];
    const linkTcolorValue = linktextcolor[index];
    const linkBgcolorValue = linkbgcolor[index];
    setBgcolor(bgcolorValue);
    setLinkTcolor(linkTcolorValue);
    setLinkBgcolor(linkBgcolorValue);
        ...
        {activeIndex && (
          <div className="mb-1">
            ...
            <div className="mb-5 mt-4 flex flex-col md:flex-row">
              ...
              {/* link text bg */}
              <div className="relative md:mx-3 flex flex-col">
                <label className="mb-1 text-[12px] font-semibold  text-[#1B254B] dark:text-[#fff]">
