...
const defaultTimeSlots: TimeSlot[] = [{ start: "08:00", end: "19:00" }];

const Openinghours: React.FC = () => {
  const [activeIndex, setActiveIndex] = useState<number>(1);
  const [hours, setHours] = useState<{ [key: string]: TimeSlot[] }>(
  ...
  const handleDeleteTimeSlot = (day: string, index: number) => {
                        ...
                        {hours[day].map((timeSlot, index) => (
                          <div key={index} className="mb-2 flex flex-col md:flex-row items-center">
                            ...
                            {timeFormat === "24" ? (
                              ...
                              render12HourTimePicker(
                                convertTo12HourTimeFormat(timeSlot.end),
                                (value) =>
