...
const ImgesDesign = () => {
  ...
  const [selectedpdfTemp, setSelectedpdfTemp] = useState(1);
  ...
  const [secondary, setSecondary] = useState("#F18430");
  const [activeIndex, setActiveIndex] = useState(1);
  const [showPrimaryPicker, setShowPrimaryPicker] = useState(false);
  const [showSecondryPicker, setShowSecondryPicker] = useState(false);
  const [colorPirmaryIndex, setColorPirmaryIndex] = useState(null);
  const [colorSecondIndex, setColorSecondIndex] = useState(null);
  ...
  const handleColorPickerChangee = (color) => {
    const { hex } = color;
  ...
  const handlePrimaryInputChange = (color) => {
    const updatedPrimaryColors = [...primaryColors];
