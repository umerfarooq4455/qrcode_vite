...
import ImgesDesign from "./Imgesdesign";
import Fonts from "./Fonts";
import Uploadimages from "./Uploadimages";
import Imgesinfo from "./Imgesinfo";
    ...
    <>
      <div className="dark:text-white ">
        ...
        <div className="mt-[14px]">
          ...
          <p className="text-sm">
            Enter the Images related content to complete the QR Code.
          </p>
        </div>
        {/* heading */}
