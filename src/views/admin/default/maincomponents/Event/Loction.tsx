...
const Loction: React.FC = () => {
  ...
  const imageUrls: string[] = [f13, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12];
                  ...
                  <button
                    ...
                    className={`mb-2 h-[47px] w-full rounded-[55px] sm:mb-0 sm:w-[150px] ${
                      activeButton === "complete"
                        ? "bg-[#5D5FEF] text-[#fff]"
                        : "border-[1px] border-[#B8BAC7] bg-[#fff] text-[#B8BAC7] dark:bg-[#212430] dark:text-[#fff]"
                    }`}
                    onClick={() => {
