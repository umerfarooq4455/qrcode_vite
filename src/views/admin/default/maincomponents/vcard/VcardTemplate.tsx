...
import image1 from "./images/v1.svg";
import image2 from "./images/v2.svg";
import image3 from "./images/v3.svg";
import image4 from "./images/v4.svg";
import image5 from "./images/v5.svg";
              ...
              {Templates.map((temp) => (
                <div
                  ...
                  className={`min-w-[126px] rounded-[10px] bg-white dark:bg-[#212430]  md:w-fit ${
                    selectedpdfTemp === temp.id.toString()
